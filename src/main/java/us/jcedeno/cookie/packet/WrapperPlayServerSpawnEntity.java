package us.jcedeno.cookie.packet;
...
public class WrapperPlayServerSpawnEntity extends AbstractPacket {
    ...
    private static PacketContainer fromEntity(Entity entity, int type, int objectData) {
        if (entityConstructor == null)
            entityConstructor = ProtocolLibrary.getProtocolManager().createPacketConstructor(TYPE, entity, type,
                    objectData);
     ...
     * Set object Data.
     * <p>
     * The content depends on the object type. See {@link #getObjectData()} for more
     * information.
     * 
